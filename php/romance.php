    ...
    <main>
        <section class="showBooks">
            <div class="content-books">
                <h1>All books of Romance</h1>
                <div class="books">
                <div class="div"><img src="../img/Romance/Adosmetrosdeti.jpeg" alt="">
                <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/Adosmetrosdeti.jpeg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
                </div>
                    <div class="div"><img src="../img/Romance/ApuestoYMaldito.jpeg" alt="">
                    <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/ApuestoYMaldito.jpeg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
                </div>
                    <div class="div"><img src="../img/Romance/cienañosdeaoledad.jpg" alt="">
                    <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/cienañosdeaoledad.jpg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
                </div>
                    <div class="div"><img src="../img/Romance/docecuentosperegrinos.jpg" alt="">
                    <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/docecuentosperegrinos.jpg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
                </div>
                    <div class="div"><img src="../img/Romance/elamorenlostiempodesdecolera.jpg" alt="">
                    <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/elamorenlostiempodesdecolera.jpg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
                </div>
                    <div class="div"><img src="../img/Romance/ElAmorHueleAcafe.jpeg" alt="">
                    <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/ElAmorHueleAcafe.jpeg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
                </div>
                    <div class="div"><img src="../img/Romance/Elbebenodeseado.jpeg" alt="">
                    <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/Elbebenodeseado.jpeg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
                </div>
                    <div class="div"><img src="../img/Romance/MalditoRomeo.jpeg" alt="">
                    <div class="box">
                    <form action="" class="form-favorite">
                        <input type="text" name="email" value="<?php echo $_SESSION['email']; ?>" hidden>
                        <input type="text" name="file" value="../img/Romance/MalditoRomeo.jpeg" hidden>
                        <input type="checkbox" name="checkbox" class="checkbox">
                    </form>
                    <p class="sinopsis">Sinopsis</p>
                </div>
